  ...
  <body>
    <div class="testbox">
      <form action="/">
        ...
        <p>Linked in profile link<span class="required">*</span></p>
            <div class="name-item">
              <input type="text" name="name" placeholder="Profile Link" required/>
            </div>

            <p>Personal website<span class="required">*</span></p>
            <div class="name-item">
              <input type="text" name="name" placeholder="url" required/>
            </div>
