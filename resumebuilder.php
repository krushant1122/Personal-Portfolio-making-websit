...
// echo '<script>alert("user data has been added")</script>';
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  // echo '<script>alert("user data has been added22")</script>';
  // $Sno = $_POST['Sno'];
  $Fname = $_POST['Fname'];
  $Lname = $_POST['Lname'];
  $gender= $_POST['gender'];
 ...
 $query = "INSERT INTO `resume` (`SNo`,`Fname`, `Lname`, `gender`, `email`, `phone`, `Estatus`, `bio`, `linked`, `Pwebsite`, `jobTitle`, `CompanyName`, `Location`, `Sdate`, `Edate`, `School`, `College`, `qualification`, `field_of_study`, `G_start_date`, `G_end_date`, `skill1`, `skill2`, `skill3`, `skill4`, `skill5`) VALUES ($id, '$Fname', '$Lname', '$gender', '$email', '$phone', '$Estatus','$bio', '$linked', '$Pwebsite', '$jobTitle', '$CompanyName', '$Location', '$Sdate', '$Edate', '$School', '$College', '$qualification', '$field_of_stud', '$G_start_date', '$G_end_date', '$skill1', '$skill2', '$skill3', '$skill4', '$skill4')";
...
<body>
  ...
  <form action="resumebuilder.php" method="post">
    <div class="testbox">
      <div class="banner">
    ...
    <div class="testbox">
      ...
      <div class="item">
        ...
        <p>Skill 1</p>
        <div class="name-item">
          <input type="text" name="skill1" placeholder="Job Title/Industry/Skill"  />

        </div>

        <p>Skill 2</p>
        <div class="name-item">
          <input type="text" name="skill2" placeholder="Job Title/Industry/Skill" />

        </div>
        <p>Skill 3</p>
        <div class="name-item">
          <input type="text" name="skill3" placeholder="Job Title/Industry/Skill"  />

        </div>
        <p>Skill 4</p>
        <div class="name-item">
          <input type="text" name="skill4" placeholder="Job Title/Industry/Skill"  />

        </div>
        <p>Skill 5</p>
        <div class="name-item">
          <input type="text" name="skill5" placeholder="Job Title/Industry/Skill"  />
